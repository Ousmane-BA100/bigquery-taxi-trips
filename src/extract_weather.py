...
def extract_weather_main(config_path: str = None):
    ...
    # Charger la configuration avec la section 'weather'
    config = load_config(config_path, 'weather')
    ...
    logger.info(f"Démarrage de l'extraction des données météo le : {datetime.now(timezone.utc)}")
...
def main(config_path: str = None):
    ...
    try:
        ...
        return extract_weather_main(config_path)
    except Exception as e:
